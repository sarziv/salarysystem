                    ...
                    <div class="card-body text-center NoMarginBottonP">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item justify-content-around  col-auto">
                                ...
                                <span class="badge badge-dark col-3">{{ $userData[0]->totalfilled}}</span>
                            </li>
                            <li class="list-group-item justify-content-around">
                                ...
                                <span class="badge badge-dark col-3">{{ $userData[0]->totalfilled * 8 + $userData[0]->totalvalandos}}</span>
                            </li>
                            <li class="list-group-item justify-content-around">
                                ...
                                <span class="badge badge-dark col-3">{{($userData[0]->totaleilutes * 0.09) + ($userData[0]->totalpallet * 0.11) + ($userData[0]->totalvip * 5)}}
                                    €</span>
                            </li>
                            <li class="list-group-item justify-content-around">
                                ...
                                <span class="badge badge-dark col-3">{{ $userData[0]->totalvalandos}}</span>
                            </li>
                            <li class="list-group-item justify-content-around">
                                ...
                                <span class="badge badge-dark col-3">{{ round((($userData[0]->totaleilutes * 0.09) + ($userData[0]->totalpallet * 0.11) + ($userData[0]->totalvip * 5)) / ($userData[0]->totalfilled * 8 + $userData[0]->totalvalandos),2) }}
                                    € </span>
                            </li>
                        </ul>
                    </div>
